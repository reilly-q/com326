...
Module::Module()
{
	...
	std::cout << "The default Module class constructor was called to create an empty module" << std::endl;
...
{
	// custom constructor
	std::cout << "The Module class custom constructor was called to create module " << moduleTitle_ << std::endl;
}

// Task - 1 Adding a destructor
Module::~Module() {
	std::cout << "Destructor of the insert Module class called on " << moduleTitle_ << std::endl;
}
