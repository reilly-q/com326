...
if bld == 0: # 0 = test
	...
	src = [varObj0 + 'main.cpp', Glob(varObj0 + 'warrior/*.cpp'), Glob(varObj0 + 'archer/*.cpp'), Glob(varObj0 + 'wizard/*.cpp'), Glob(varObj0 + 'weapon/*.cpp'), Glob(varObj0 + 'item/*.cpp'), Glob(varObj0 + 'armour/*.cpp')] # set all source files
	...
	src = [varObj0 + 'main.cpp', Glob(varObj1 + 'warrior/*.cpp'), Glob(varObj1 + 'archer/*.cpp'), Glob(varObj1 + 'wizard/*.cpp'), Glob(varObj1 + 'weapon/*.cpp'), Glob(varObj1 + 'item/*.cpp'), Glob(varObj1 + 'armour/*.cpp')] # set all source files
